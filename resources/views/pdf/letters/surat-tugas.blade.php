    ...
    <div class="content">
        ...
        <table class="no-border" style="width: 100%; margin-left: 20px;">
            <tr>
                ...
                <td style="border:none;"><strong>{{ $metadata['signer_name'] ?? 'Aria Mulyapradana, S.Psi., M.A.' }}</strong></td>
            </tr>
            <tr>
                <td style="border:none;">Jabatan</td>
                <td style="border:none;">:</td>
                <td style="border:none;">{{ $metadata['signer_position'] ?? 'Kepala LPPM ITSNU Pekalongan' }}</td>
            </tr>
            <tr>
                <td style="border:none;">Alamat</td>
                <td style="border:none;">:</td>
                <td style="border:none;">{{ $metadata['signer_address'] ?? 'Jl. Karangdowo No. 9 Kedungwuni Pekalongan' }}</td>
            </tr>
        </table>
