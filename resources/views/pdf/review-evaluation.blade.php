    ...
    <table class="header-table no-border">
        <tr>
            ...
            <td class="header-text" style="border: none !important; padding: 0 !important; vertical-align: middle; text-align: center;">
                <div style="font-size: 14pt; font-weight: bold; text-transform: uppercase; line-height: 1.2; letter-spacing: 0.2px;">
                ...
                <div style="font-size: 14pt; font-weight: bold; text-transform: uppercase; line-height: 1.25; letter-spacing: 0.2px;">
                    Ulama Pekalongan
                </div>
