@php
    $icons = [
        ...
        'flask' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
                            <path d="M9 3l6 0" />
                            <path d="M10 9l4 0" />
        ...
        'flask-2' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
                            <path d="M6.1 15h11.8" />
                            <path d="M14 3v7.342a6 6 0 1 0 -4 0v-7.342" />
                            <path d="M9 3h6" />
                        </svg>
                        SVG;
        },
        'users-group' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'chart-pie' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
                            <path d="M10 3.2a9 9 0 1 0 10.8 10.8a1 1 0 0 0 -1 -1h-6.8a1 1 0 0 1 -1 -1v-6.8a1 1 0 0 0 -1 -1z" />
                            <path d="M15 3.5a9 9 0 0 1 5.5 5.5h-4.5a1 1 0 0 1 -1 -1v-4.5z" />
                        </svg>
                        SVG;
        },
        'wallet' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'file-pencil' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
                            <path d="M14 3v4a1 1 0 0 0 1 1h4" />
        ...
        'shield-check' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'stars' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'target-arrow' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'layout-grid' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'calendar-event' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
        ...
        'file-export' => static function (string $class): string {
            return <<<SVG
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{$class}">
                            <path d="M14 3v4a1 1 0 0 0 1 1h4" />
