...
<x-slot:title>Monitoring Laporan Akhir (Admin LPPM)</x-slot:title>
<x-slot:pageTitle>Monitoring Laporan Akhir</x-slot:pageTitle>
<x-slot:pageSubtitle>
    Pantau dan kelola seluruh status laporan akhir penelitian dan pengabdian lintas fakultas.
</x-slot:pageSubtitle>
...
<div>
    ...
    <div class="row row-cards mb-3">
        ...
        <div class="col-sm-6 col-lg">
            <div class="card card-sm border-0 shadow-sm" style="border-left: 3px solid #d63939 !important;">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <span class="bg-danger text-white avatar"><i class="ti ti-alert-circle fs-2"></i></span>
                        </div>
                        <div class="col">
                            <div class="font-weight-medium text-danger">{{ $this->stats['rejected'] }} Laporan</div>
    ...
    <!-- Table -->
    @include('livewire.partials.report-approval-table', ['role' => 'admin_lppm'])
</div>
