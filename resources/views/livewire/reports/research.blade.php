<div>
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div class="btn-list">
                        ...
                        @if(active_role() === 'rektor' && ($institutionalReport?->status === \App\Enums\InstitutionalReportStatus::SUBMITTED))
                            ...
                            <button class="btn btn-success shadow-sm" wire:click="approveInstitutionalReport('research', {{ $period }})"
                                wire:loading.attr="disabled">
    ...
    <div class="row row-cards">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Daftar Seluruh Penelitian') }} — {{ $period }}</h3>
                </div>
                <div class="p-0 card-body">
                    <div class="table-responsive">
                        <table class="card-table table table-vcenter text-nowrap">
                            ...
                            <tbody>
                                @forelse ($proposals as $index => $research)
                                    <tr>
