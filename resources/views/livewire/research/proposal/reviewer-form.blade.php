                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-2">
                                            ...
                                            @if ($review->completed_at)
                                                <small class="text-muted italic">
                                                     Diselesaikan pada: {{ $review->completed_at ? \Carbon\Carbon::parse($review->completed_at)->format('d M Y H:i') : 'Belum selesai' }}
                                                 </small>
                                            @endif
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="align-items-start row g-3">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div
                                                                ...
                                                                @if ($log->completed_at)
                                                                    <small class="text-muted italic">
                                                                          {{ $log->completed_at ? \Carbon\Carbon::parse($log->completed_at)->format('d M Y H:i') : 'Belum selesai' }}
                                                                    </small>
                                                                @endif
                                                            </div>
                                                        </div>
                            ...
                            @if ($this->deadline)
                                <div class="ps-3 col-auto" style="border-left: 1px solid var(--tblr-border-color);">
                                    ...
                                    <div class="fw-bold {{ $this->isOverdue ? 'text-danger' : 'text-body' }}">
                                        ...
                                        {{ $this->deadline ? \Carbon\Carbon::parse($this->deadline)->format('d M Y') : '-' }}
                                        @if ($this->isOverdue)
                    ...
                    <div class="card-body">
                        @if ($errors->has('error'))
                            <div class="mb-4 alert alert-danger" role="alert">
                                <div class="d-flex">
                                    <x-lucide-alert-circle class="me-2 alert-icon" />
