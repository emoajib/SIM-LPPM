...
@php
    ...
    $budgetCap = \App\Models\BudgetCap::getCapForPeriod($currentYear, $currentSemester, 'research', $schemeId ? (int) $schemeId : null);
...
<!-- Section: Jadwal Pelaksanaan Penelitian (Lampiran 3 PDF) -->
<div class="card mb-3">
    <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
            <div class="d-flex align-items-center">
                <x-lucide-calendar class="icon me-3" />
                <h3 class="card-title mb-0">Jadwal Pelaksanaan Penelitian
