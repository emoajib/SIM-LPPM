<x-slot:title>Laporan Kemajuan Pengabdian</x-slot:title>
<x-slot:pageTitle>Laporan Kemajuan Pengabdian</x-slot:pageTitle>
<x-slot:pageSubtitle>
    Buat dan kelola laporan kemajuan untuk pengabdian yang telah disetujui.
</x-slot:pageSubtitle>
                ...
                <tbody>
                    @forelse ($this->proposals as $proposal)
                        <tr wire:key="proposal-{{ $proposal->id }}">
                            ...
                            <td>
                                <a href="{{ route('community-service.progress-report.show', $proposal) }}"
