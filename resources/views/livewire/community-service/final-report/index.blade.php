...
<x-slot:pageTitle>Laporan Akhir Pengabdian (PKM)</x-slot:pageTitle>
<x-slot:pageSubtitle>
    Pantau progres, filter status, dan kelola laporan akhir pengabdian kepada masyarakat yang telah didanai.
</x-slot:pageSubtitle>
...
<div>
    ...
    <div class="row row-cards mb-3">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <div class="text-secondary small">{{ $this->statistics['total'] }} PKM</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card card-sm cursor-pointer {{ $statusFilter === 'belum_laporan' ? 'border-warning shadow' : '' }}"
                wire:click="filterByStatus('belum_laporan')" title="Filter PKM yang Belum Mengunggah Laporan">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="Cari judul, pelaksana, atau NIDN..."
                        ...
                        <div class="col-md-3">
                            <select class="form-select" wire:model.live="schemeFilter">
                                <option value="all">Semua Skema PKM</option>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Daftar Laporan Akhir Pengabdian (PKM)</h3>
            ...
            <table class="card-table table-vcenter table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Pelaksana & Fakultas/Prodi</th>
                            ...
                            <td class="text-wrap" style="max-width: 380px;">
                                ...
                                <div class="mt-1 d-flex align-items-center gap-1">
                                    <x-tabler.badge variant="outline" class="text-muted small">
                                        {{ $proposal->communityServiceScheme?->name ?? 'Tanpa Skema' }}
                                    </x-tabler.badge>
                        ...
                        <tr>
                            <td colspan="5" class="py-5 text-center">
                                ...
                                <p class="text-secondary mb-1">
                                    Tidak ada data laporan akhir PKM yang sesuai filter.
                                </p>
