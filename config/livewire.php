...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK'), // Example: 'local', 'public'       | Default: 'default'
        'rules' => ['required', 'file', 'max:524288'], // 512MB limit in KB
    ...
    */
    ...
    'payload' => [
        'max_size' => 20480 * 1024,   // 20MB - maximum request payload size in bytes
